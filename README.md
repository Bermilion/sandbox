...
Пакеты выкачиваются через git в папку chunker2i. Оттуда по стандарту PSR-4 в composer.json пространства имён пакетов добавляются в песочницу. А через файл bootstrap/providers сервис-провайдеры пакетов подключаются в песочницу, чтобы иметь возможность публиковать ассеты.
